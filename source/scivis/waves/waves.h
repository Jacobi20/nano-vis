...
const int		NN		=	100 ;		//	Число гармоник в модели Лонге-Хиггинса (2D)
...
const float		nQ		=	0.6f ;		//	бортовая
const float		a3		=	0.0f ;
const float		a5		=	0.0f ;
const float		v1_44	=	0.04f ;

const float		v33		=	0.07f ;		//	вертикальная
const float		a33_1	=	0.50f ;
const float		a33_2	=	0.83f ;
const int		Mu33	=	700 ;
const int		Nu33	=	200 ;

const float		v55		=	0.1f ;		//	килевая
...
{//change_papams_to_bort_reson
	Wmax = 2.2f /*2.0f*/;	// == Максимальная частота ==
	W0   = 1.41f  /*1.2f*/ ;	//	Средняя частота волны, рад/c
	BSp  = 0.030f /*1.3f*/ ; // == Параметр формы спектра ==
	ASp  = 0.233f /*10*/;	// == Параметр масштаба спектра ==
	Wmin = 0.2f /*0.2f*/ ;	//	Минимальная частота
	alfa=0./*0.03f*/;
	bS = 0.933f /* 1.44f */;
...
void wave_pos2D(Matrix& pos, float t)
{
	float x=0.;
